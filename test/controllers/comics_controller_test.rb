...
class ComicsControllerTest < ActionController::TestCase
  ...
  test "should create comic" do
    assert_difference('Comic.count') do
      post :create, comic: { description: @comic.description, title: @comic.title, user_id: @comic.user_id }
    end
  ...
  test "should update comic" do
    patch :update, id: @comic, comic: { description: @comic.description, title: @comic.title, user_id: @comic.user_id }
    assert_redirected_to comic_path(assigns(:comic))
  end
